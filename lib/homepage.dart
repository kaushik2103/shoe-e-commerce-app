...
class _homePageState extends State<homePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Color(0xFF003a30), // status bar color
    ));
    return Scaffold(
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("images/top.png"), fit: BoxFit.cover),
                ),
                child: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        Text(
                          "Air Drop Shoes",
                          style: appstyleHt(
                              36, Colors.white, FontWeight.w700, 1.5),
                        ),
                        Text(
                          "Collection",
                          style: appstyleHt(
                              36, Colors.white, FontWeight.w700, 1.2),
                        ),
                        TabBar(
                            ...
                            labelStyle:
                                appstyle(22, Colors.white, FontWeight.w700),
