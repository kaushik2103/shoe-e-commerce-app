            ...
            return isLoading
                ...
                : Scaffold(
                    ...
                    body: SafeArea(
                      child: Scaffold(
                          backgroundColor: Color(kSecondaryColor),
                          body: Consumer<ProductNotifiers>(
                            builder: (context, productNotifiers, child) {
                              productNotifiers.valSet(
                                  isCarted, widget.shoesize);
                                        ...
                                        children: [
                                          SizedBox(
                                            height: MediaQuery.of(context)
                                                    ...
                                                    .height *
                                                0.8,
                                            // it means 50 porcent of the height of the phone
                                                  ...
                                                  return Stack(
                                                    children: [
                                                      ...
                                                      Positioned(
                                                          top: 140,
                                                          right: 0,
                                                          // to get at the center it right and left should be zero
                                                          left: 0,
                                                          height: MediaQuery.of(
                                                                      context)
                                                                  .size
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              side: BorderSide(color: shoessize[index]["isSelected"] ? Color(kPrimaryColor) : Color(kSecondaryColor), width: 0.5, style: BorderStyle.solid),
                                                                              label: Text(
                                                                                shoessize[index]["size"],
                                                                                style: appstyle(18, shoessize[index]["isSelected"] ? Color(kSecondaryColor) : Color(kPrimaryColor), FontWeight.w600),
                                                                              ),
                                                                              selectedColor: Color(kPrimaryColor),
                                                                              selected: shoessize[index]["isSelected"],
                                                                              onSelected: (newsState) {
                                                                                productNotifiers.toggleChecked(index);
                                                                              },
                                                                            ),
                                                                          ),
                                                                        );
